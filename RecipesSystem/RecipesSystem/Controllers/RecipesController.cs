...
namespace RecipesSystem.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecipeID,Title,Content,ChefID")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecipeID,Title,Content,ChefID")] Recipe recipe)
        {
            if (ModelState.IsValid)
            {
